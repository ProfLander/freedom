...
- [ ] Generalize winit executor scheduling to the main run loop?
  - May be better to have direct control than let smol's arbitrary 200-iteration machinery decide
  - Conversely, that may be an optimization targeted at compiler loop unrolling
    - i.e. A contributing factor to its speed
